...
const speakers = [
  {
    ...
    image: "/speakers/sonal-sarda.jpg",
    linkedin: "#",
  },
  {
    name: "Shefali Arora",
    role: "AWS AI Engineering Community Builder | Speaker | AWS Lead Instructor | GenAI | Cloud Auditor | AWS reStart Instructor | Machine Learning | Data Science | Training Program Manager | Freelancer",
    company: "",
    session: "GenAI",
    bio: "Community builder and instructor working across GenAI, ML and data science training programs.",
    image: "/speakers/shefali-arora.jpg",
    linkedin: "#",
  },
  {
    name: "Coming Soon",
